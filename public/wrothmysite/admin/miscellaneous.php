...
<head>
<meta charset="utf-8">
<title>Miscellaneous - Worth My Site</title>
...
if(isset($_GET['site_ss_clean']))
{
    delDir('../site_snapshot');
...
{
    $query = "DELETE FROM domains_data"; 
    mysqli_query($con,$query); 
    ...
    else
    {
         $msg = '<div class="alert alert-success">
         <button data-dismiss="alert" class="close" type="button">&times;</button>
         <strong>Alert!</strong> All indexed data has been deleted successfully
         </div>';
    }
	      	...
	      	<div class="span12">      		
                ...
                <button data-dismiss="alert" class="close" type="button">&times;</button>
                 <strong>Warning!</strong> All actions are irreversible! 
                           ...
                           <center>   
                          	<br /> <hr />              
                              <label style="font-weight: bold;"> Clear all site screenshot data</label>
                             <a href="miscellaneous.php?site_ss_clean" class="btn btn-danger">Process</a>
                             <hr /> 
                             
                            	<br /> <hr />              
                              <label style="font-weight: bold;"> Clear all indexed domain data</label>
                             <a href="miscellaneous.php?clean_all" class="btn btn-danger">Process</a>
                             <hr /> 	<br />
