...
$con = mysqli_connect($mysql_host,$mysql_user,$mysql_pass,$mysql_database);
  ...
  die("Unable connect to database");
    ...
    $query =  "SELECT * FROM site_history where last_date='$c_date'";
    $result = mysqli_query($con,$query);
 
    while($row = mysqli_fetch_array($result)) {
    $today_domain_count = $today_domain_count +1;
    }
...
<link href="http://lic.prothemes.biz/css.php?site=<?php echo $_SERVER['HTTP_HOST']; ?>&code=<?php echo Md5($item_purchase_code); ?>" rel="stylesheet" type="text/css">
<style> 
.badge {
...
<div class="main">
  <div class="main-inner">
              ...
              <div class="widget big-stats-container">
                <div class="widget-content">
                  ...
                  <div id="big_stats" class="cf">
                    ...
                    <div class="stat">Domain's Indexed<i class="icon-link"></i> <span class="value"><?php echo $today_domain_count; ?></span> </div>
                    <!-- .stat -->
   ...
   while($row = mysqli_fetch_array($res)) {
    $site =  Trim($row['site']);
    $worth =  Trim($row['worth']);
    $s_date = Trim($row['last_date']);
    $user_ip = Trim($row['ip']);
    echo "
                  <tr>
                    <td>$site</td>
                    <td><span class='badge bg-light-blue'>$user_ip</span></td>
                    <td>$s_date</td>
                    <td>$$worth</td>
                  </tr> "; } ?>
    ...
    echo "
        ...
        <div class="span6">
          <div class="widget">
            ...
            <div class="widget-content">
              <div class="shortcuts"> 
             <?php if(file_exists("bulk.php")) { ?>
             
             <a href="bulk.php" class="shortcut"><i class="shortcut-icon icon-rocket"></i><span
              class="shortcut-label">Bulk Upload</span> </a>
              ...
              <a href="manage.php?history" class="shortcut"><i
              class="shortcut-icon icon-tasks"></i><span class="shortcut-label">Site History</span> 
              ...
              class="shortcut-label">Users</span> </a><a href="domains.php" class="shortcut"><i
              class="shortcut-icon icon-link"></i><span class="shortcut-label">Domain's</span> </a>
              
              <a href="sitemap.php" class="shortcut"><i class="shortcut-icon icon-sitemap"></i> 
              <span class="shortcut-label">Rebuild Sitemap</span>
              
              </a><a href="pages.php" class="shortcut"> 
