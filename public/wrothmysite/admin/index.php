...
{
if ($adminid == htmlspecialchars(trim($_POST['username'])))
  {
...
<head>
    <meta charset="utf-8">
    <title>Login - Worth My Site</title>
...
<center>Copyright &copy; 2020 <a href="https://prothemes.biz/">ProThemes.Biz.</a> </center>
</div> <!-- /login-extra -->
