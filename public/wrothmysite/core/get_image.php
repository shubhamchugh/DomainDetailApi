...
if (file_exists("site_snapshot/$site.jpg")){
    $myimage = "../site_snapshot/$site.jpg";
} else {

    $name = "../site_snapshot/$site.jpg";
    $imgSrc = file_get_contents("http://".$pss[2] . $pss[1] . $pss[0] .".prothemes.biz/api/screen.php?site=$site&domain=".$_SERVER['HTTP_HOST']."&code=$item_purchase_code");
    $myFile = $name;
